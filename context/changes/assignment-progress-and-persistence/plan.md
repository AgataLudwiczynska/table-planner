...
- [ ] 2.1 Existing suite still green: `npm run lint` and `npm run test:run`

#### Manual

- [ ] 2.2 Seed wedding (≥2 tables, several guests, ≥1 conflict, several assignments incl. a seated conflicting pair); record N/M, K, layout
- [ ] 2.3 Log out and log back in as the same operator
- [ ] 2.4 After login: same N/M, each guest on the same seat
- [ ] 2.5 After login: same K conflicts and same flagged violations
- [ ] 2.6 After login: all tables unchanged (names, seat counts, seat numbering)
